...
Redball is a **Windows-native application** built with WPF and .NET 10:
...
- **CI pipeline**: GitHub Actions with self-hosted Ubuntu runner produces Windows artifacts

This approach prioritises native Windows user experience with WPF.
